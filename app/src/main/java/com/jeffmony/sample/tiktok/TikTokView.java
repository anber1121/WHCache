...
import com.tencent.videoplayer.controller.ControlWrapper;
import com.tencent.videoplayer.controller.IControlComponent;
    ...
    public void onPlayStateChanged(int playState) {
        switch (playState) {
            case VideoView.STATE_IDLE:
                L.d("-xb-STATE_IDLE " + hashCode());
                thumb.setVisibility(VISIBLE);
                break;
            case VideoView.STATE_PLAYING:
                L.d("-xb-STATE_PLAYING " + hashCode());
                thumb.setVisibility(GONE);
                mPlayBtn.setVisibility(GONE);
                break;
            case VideoView.STATE_PAUSED:
                L.d("-xb-STATE_PAUSED " + hashCode());
                thumb.setVisibility(GONE);
                mPlayBtn.setVisibility(VISIBLE);
                break;
            case VideoView.STATE_PREPARED:
                L.d("-xb-STATE_PREPARED " + hashCode());
                break;
            case VideoView.STATE_ERROR:
                L.d("-xb-STATE_ERROR " + hashCode());
                Toast.makeText(getContext(), R.string.whplayer_error_message, Toast.LENGTH_SHORT).show();
                break;
        }
    }
