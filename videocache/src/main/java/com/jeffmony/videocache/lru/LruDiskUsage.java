package com.jeffmony.videocache.lru;
        ...
        for (File file : files) {
            ...
            if (!accepted) {
                ...
                if (deleted) {
                    totalCount--;
                    totalSize -= fileSize;
                    LogUtils.i("","Cache file " + file + " is deleted because it exceeds cache limit");
                } else {
                    LogUtils.e("","Error deleting file " + file + " for trimming cache");
                }
            }
        }
    }
